...
const (
	Payments_MakePayment_FullMethodName       = "/payments.Payments/MakePayment"
	Payments_GetPayments_FullMethodName       = "/payments.Payments/GetPayments"
	Payments_UpdatePayment_FullMethodName     = "/payments.Payments/UpdatePayment"
	Payments_DeletePayment_FullMethodName     = "/payments.Payments/DeletePayment"
	Payments_GetStatus_FullMethodName         = "/payments.Payments/GetStatus"
	Payments_ValidatePaymentId_FullMethodName = "/payments.Payments/ValidatePaymentId"
)
...
func (c *paymentsClient) MakePayment(ctx context.Context, in *Payment, opts ...grpc.CallOption) (*Id, error) {
	...
	out := new(Id)
	err := c.cc.Invoke(ctx, Payments_MakePayment_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *paymentsClient) GetPayments(ctx context.Context, in *PaymentsFilter, opts ...grpc.CallOption) (*AllPayments, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AllPayments)
	err := c.cc.Invoke(ctx, Payments_GetPayments_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *paymentsClient) DeletePayment(ctx context.Context, in *Id, opts ...grpc.CallOption) (*Void, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Void)
	err := c.cc.Invoke(ctx, Payments_DeletePayment_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *paymentsClient) GetStatus(ctx context.Context, in *Id, opts ...grpc.CallOption) (*Status, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Status)
	err := c.cc.Invoke(ctx, Payments_GetStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *paymentsClient) ValidatePaymentId(ctx context.Context, in *Id, opts ...grpc.CallOption) (*Status, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Status)
	err := c.cc.Invoke(ctx, Payments_ValidatePaymentId_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Payments_MakePayment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Payments_MakePayment_FullMethodName,
	}
...
func _Payments_GetPayments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Payments_GetPayments_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Payments_DeletePayment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Payments_DeletePayment_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Payments_GetStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Payments_GetStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Payments_ValidatePaymentId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Payments_ValidatePaymentId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
