...
const (
	...
	ReservationService_ValidateReservationId_FullMethodName = "/reservation.ReservationService/ValidateReservationId"
	ReservationService_GetAllReservations_FullMethodName    = "/reservation.ReservationService/GetAllReservations"
)
...
func (c *reservationServiceClient) ValidateReservationId(ctx context.Context, in *Id, opts ...grpc.CallOption) (*Exists, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Exists)
	err := c.cc.Invoke(ctx, ReservationService_ValidateReservationId_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reservationServiceClient) GetAllReservations(ctx context.Context, in *ReservationFilter, opts ...grpc.CallOption) (*Reservations, error) {
	...
	err := c.cc.Invoke(ctx, ReservationService_GetAllReservations_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ReservationService_ValidateReservationId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReservationService_ValidateReservationId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
